...
const faveColors = ['blue', 'purple', 'yellow']
...
const me = {
    firstName: 'Ali',
    superHeroName: 'The Most Audacious Ali',
    homeTown: 'Bullhead City',
    superPowers: ['martial arts', 'a dangerous amount sarcasm', 'laser beam eyes'],
